...
BEGIN
	...
	BEGIN TRY
		...
		PRINT '>>Truncacting Table: bronze.crm_cust_info';
		...
		SET @start_time = GETDATE();
		PRINT '>>Truncacting Table: bronze.crm_prd_info';
		...
		SET @start_time = GETDATE();
		PRINT '>>Truncacting Table: crm_sales_details';
		...
		SET @start_time = GETDATE();
		PRINT '>>Truncacting Table: bronze.erp_cust_az12';
		...
		SET @start_time = GETDATE();
		PRINT '>>Truncacting Table: bronze.erp_loc_a101';
		...
		SET @start_time = GETDATE();
		PRINT '>>Truncacting Table: bronze.erp_px_cat_g1v2';
